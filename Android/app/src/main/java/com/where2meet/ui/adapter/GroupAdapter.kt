        ...
        fun bind(data: MiniGroup?) {
            ...
            with(binding) {
                ...
                if (data.status == "Done") {
                    ...
                    statusCard.setCardBackgroundColor(ctx.getColorFromAttr(com.google.android.material.R.attr.colorPrimary))
                } else {
                    tvStatus.text = ctx.getString(R.string.lbl_pending)
                    tvStatus.setTextColor(ctx.getColorFromAttr(com.google.android.material.R.attr.colorOnTertiaryContainer))
                    statusCard.setCardBackgroundColor(ctx.getColorFromAttr(com.google.android.material.R.attr.colorTertiaryContainer))
                }
            }
        }
    }
